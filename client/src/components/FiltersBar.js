...
function FiltersBar({ languages, topics, setLanguageFilter, setTopicFilter}) {
    ...
    return (
        <div className="filters-container">
                    <select className="filter-select" id="language-filter" onChange={event => setLanguageFilter(event.target.value)}>
                    ...
                    <select className="filter-select" id="topic-filter" onChange={event => setTopicFilter(event.target.value)}>
